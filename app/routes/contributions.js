...
function ContributionsHandler(db) {
    ...
    this.handleContributionsUpdate = (req, res, next) => {
        ...
        const preTax = eval(req.body.preTax); // pre-tax contribution %
        const afterTax = eval(req.body.afterTax); // after-tax contribution %
        const roth = eval(req.body.roth); // roth contribution %
